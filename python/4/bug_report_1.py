...
def draw():
	...
	for n in range(1):
		...
		end_angle = get_end_angle_in_bounds(_e_a, low_bounds=25, high_bounds=80) + 270
		start_radius = random.randint(330, 390)
		...
		for p in range(30):
			...
			noiseness = 0
			final_distance = curr_raidus + noiseness
			d_x, d_y = delta_coords(end_angle + 90, final_distance)
